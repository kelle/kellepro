pro mac_mm2, parmfile, IMAGES=images, OUTIMAGE=outimage, 		     $
...
imcube = fltarr(ncells,ncells,5) ; saved images from the 5-box pattern
...
FOR range = 0,nranges-1 do begin
   ...
   if npeaks(range) eq 14 then begin
     chop1a = dir + '/' + label + string(format='(i4.4)',i) + '.a' + zip_ext        
     chop1b = dir + '/' + label + string(format='(i4.4)',i+1) + '.a' + zip_ext
     chop1c = dir + '/' + label + string(format='(i4.4)',i+2) + '.a' + zip_ext
     chop1d = dir + '/' + label + string(format='(i4.4)',i+3) + '.a' + zip_ext
     chop1e = dir + '/' + label + string(format='(i4.4)',i+4) + '.a' + zip_ext
     chop1f = dir + '/' + label + string(format='(i4.4)',i+5) + '.a' + zip_ext
     chop1g = dir + '/' + label + string(format='(i4.4)',i+6) + '.a' + zip_ext
     chop2a = dir + '/' + label + string(format='(i4.4)',i+7) + '.a' + zip_ext        
     chop2b = dir + '/' + label + string(format='(i4.4)',i+8) + '.a' + zip_ext
     chop2c = dir + '/' + label + string(format='(i4.4)',i+9) + '.a' + zip_ext
     chop2d = dir + '/' + label + string(format='(i4.4)',i+10) + '.a' + zip_ext
     chop2e = dir + '/' + label + string(format='(i4.4)',i+11) + '.a' + zip_ext
     chop2f = dir + '/' + label + string(format='(i4.4)',i+12) + '.a' + zip_ext
     chop2g = dir + '/' + label + string(format='(i4.4)',i+13) + '.a' + zip_ext

     beam1a = readfits(chop1a,h,/SILENT)
     beam1b = readfits(chop1b,h,/SILENT)
     beam1c = readfits(chop1c,h,/SILENT)
     beam1d = readfits(chop1d,h,/SILENT)
     beam1e = readfits(chop1e,h,/SILENT)
     beam1f = readfits(chop1f,h,/SILENT)
     beam1g = readfits(chop1g,h,/SILENT)
     beam2a = readfits(chop2a,h,/SILENT)
     beam2b = readfits(chop2b,h,/SILENT)
     beam2c = readfits(chop2c,h,/SILENT)
     beam2d = readfits(chop2d,h,/SILENT)
     beam2e = readfits(chop2e,h,/SILENT)
     beam2f = readfits(chop2f,h,/SILENT)
     beam2g = readfits(chop2g,h,/SILENT)
     ...
     diff(*,*,4) = diff(*,*,4) + float(beam5 - beam6)
     diff(*,*,5) = diff(*,*,5) + float(beam6 - beam7)
     diff(*,*,6) = diff(*,*,6) + float(beam7 - beam6)
   ENDIF

   if(npeaks(range) eq 7) then begin
     ...
     chopd = dir + '/' + label + string(format='(i4.4)',i+5) + '.a' + zip_ext
     chope = dir + '/' + label + string(format='(i4.4)',i+6) + '.a' + zip_ext
	...
	message,/cont,' Unable to locate file '+chopc
 	return
     END
     beam6 = readfits(chopd,hc,/SILENT)
     if beam6(0) eq -1 then begin
	message,/cont,' Unable to locate file '+chopd
 	return
     end
     beam7 = readfits(chope,hc,/SILENT)
     if beam7(0) eq -1 then begin
	message,/cont,' Unable to locate file '+chope
 	return
     end
     diff(*,*,1) = diff(*,*,1) + float(beam2 - beam3)
     diff(*,*,2) = diff(*,*,2) + float(beam3 - beam4)
   ...
   if(npeaks(range) eq 9) then begin
     chopa = dir + '/' + label + string(format='(i4.4)',i+2) + '.a' + zip_ext
     chopb = dir + '/' + label + string(format='(i4.4)',i+3) + '.a' + zip_ext
     chopc = dir + '/' + label + string(format='(i4.4)',i+4) + '.a' + zip_ext
     chopd = dir + '/' + label + string(format='(i4.4)',i+5) + '.a' + zip_ext
     chope = dir + '/' + label + string(format='(i4.4)',i+6) + '.a' + zip_ext
     chopf = dir + '/' + label + string(format='(i4.4)',i+7) + '.a' + zip_ext
     chopg = dir + '/' + label + string(format='(i4.4)',i+8) + '.a' + zip_ext
	...
	message,/cont,' Unable to locate file '+chope
     ...
     beam8 = readfits(chopf,hc,/SILENT)
     if beam8(0) eq -1 then begin
	message,/cont,' Unable to locate file '+chopf
 	return
     end
     beam9 = readfits(chopg,hc,/SILENT)
     if beam9(0) eq -1 then begin
	message,/cont,' Unable to locate file '+chopg
 	return
     end
     diff(*,*,1) = diff(*,*,1) + float(beam2 - beam3)
     diff(*,*,2) = diff(*,*,2) + float(beam3 - beam4)
     ...
     diff(*,*,4) = diff(*,*,4) + float(beam5 - beam6)
     diff(*,*,5) = diff(*,*,5) + float(beam6 - beam7)
     diff(*,*,6) = diff(*,*,6) + float(beam7 - beam8)
     diff(*,*,7) = diff(*,*,7) + float(beam8 - beam9)
     diff(*,*,8) = diff(*,*,8) + float(beam9 - beam8)	
   endif 
   ...
   if(npeaks(range) eq 5) then begin
	...
	message,/cont,' Unable to locate file '+chopc
     ...
     diff(*,*,2) = diff(*,*,2) + float(beam3 - beam4)
     diff(*,*,3) = diff(*,*,3) + float(beam4 - beam5)
     diff(*,*,4) = diff(*,*,4) + float(beam5 - beam1)
   endif 

   if(npeaks(range) eq 3) then begin         
     chopa = dir + '/' + label + string(format='(i4.4)',i+2) + '.a' + zip_ext
     beam3 = readfits(chopa,h,/SILENT)
     if beam3(0) eq -1 then begin
	message,/cont,' Unable to locate file '+chopa
	return
     ...
     diff(*,*,1) = diff(*,*,1) + float(beam2 - beam3)
     diff(*,*,2) = diff(*,*,2) + float(beam3 - beam2)           
   endif 
...
; Add to bin.
	   ...
	   yhigh = ny/2 + (ncells/2-1)
           ...
           imcube(xlow:xhigh,ylow:yhigh,jcountno) =  diffshift(xlow:xhigh,ylow:yhigh)
           jcountno=jcountno+1
