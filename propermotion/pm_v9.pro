...
IF n_elements(GET_FILE(obj,'logs/',/SILENT)) gt 1 THEN BEGIN ;previous ref data file exists
...
IF see eq 'y' THEN BEGIN
 coeffs2=coeffs(ra_target, dec_target ,x_target, y_target, ra_ref, dec_ref, x_ref, y_ref, obj, run, log=0, view=1)
ENDIF
