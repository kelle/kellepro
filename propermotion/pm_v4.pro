...
PRO pm_v4;, coords_file, POSS_image_file, image_file_2M, tvmag=tvmag, log=log_set
...
;max # of ref stars is num of lines in file
 ...
 ENDWHILE ; while quite_ref=0 and not EOF(lun_coords)
 close, lun_coords
 FREE_LUN, lun_coords
 ...
 save, file=ref_data_file, image,hdr,nx,ny,tk,date_xy, date_target,ra_target, dec_target, x_target, y_target, ra_ref, dec_ref, x_ref, y_ref
