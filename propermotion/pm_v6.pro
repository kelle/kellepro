...
PRO pm_v6;, coords_file, POSS_image_file, image_file_2M, tvmag=tvmag, log=log_set
...
;-----------------------
 ...
 ;coords_file='ref_lis/testreflis.tbl'
 coords_file='ref_lis/allref_lis.tbl'
 ;Expect one large coords file in ref_lis directory
...
;expect user to create template using ASCII_TEMPLATE for ref_lis
restore, file='ref_lis/template.sav'
