pro combine_phx, outfile, outspec, plot=plot;,ps=ps
...
@colors_kc
device, decomposed=0
color=[blue,cyan,purple,dkpurple2,pink,red,purple,ltorange,dkorange]
...
mc_meancomb,flux_arr[*,keep],mean_flux,mvar
...
;;;;REDO TO REFLECT KEPT and DISCARDED SPECTRA
